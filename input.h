// Copyright 2013-2019 René Ladan and "JsBergbau"
// SPDX-License-Identifier: BSD-2-Clause

#ifndef NPLPI_INPUT_H
#define NPLPI_INPUT_H
...
enum eGB_bitvalue {
	/** this bit has value 00 */
	ebv_00,
	/** this bit has value 10 */
	ebv_10,
	/** this bit has value 01 */
	ebv_01,
	/** this bit has value 11 */
	ebv_11,
	/** this is the begin-of-minute marker */
	ebv_bom,
	/** bit value could not be determined */
	ebv_none
};

/** Indicates if begin-of-minute happened, and related errors */
/*XXX relevant for nplpi? */
enum eGB_marker {
	/** normal bit */
	emark_none,
	/** begin-of-minute marker */
	emark_minute,
	/** bit buffer would overflow */
	emark_toolong,
	/** late begin-of-minute marker, split bits? */
	emark_late
};
...
struct bitinfo {
	...
	/**
	 * the average length of the high part of bit 0 (minute marker) in samples
	 */
 ...
 *
 * @return The bit buffer, an array of values 0..3
 */
