// Copyright 2016-2019 René Ladan
// SPDX-License-Identifier: BSD-2-Clause

#ifndef NPLPI_CALENDAR_H
#define NPLPI_CALENDAR_H
...
/**
 * Textual representation of the day of week, with Sunday = 0, Saturday = 6,
 * and an unknown day being 7.
 */
...
/**
 * Convert the given time in ISO format to NPL format.
 *
 * year starts at base_year, month = 1..12, mday = 1..lastday, Sunday = 0,
 * yday = 1..366
 *
 * @param isotime The time in ISO format to convert
 * @return The time in NPL format.
 */
struct tm get_npltime(struct tm isotime);

/**
 * Convert the given time in NPL format to ISO format.
 *
 * year starts at base_year - 1900, month = 0..11, mday = 1..lastday,
 * Sunday = 0, yday = 0..365
 *
 * @param npltime The time in NPL format to convert
 * @return The time in ISO format.
 */
struct tm get_isotime(struct tm npltime);
